...
export default function Banner() {
  ...
  return (
    <section className="h-screen w-full relative flex justify-center items-center overflow-hidden bg-banner bg-cover z-50">
      ...
      <img src="/dreamocel.png" alt="" className="absolute bottom-0 z-30 pointer-events-none h-[480px] sm:h-[520px] 2xl:h-[620px] 3xl:h-[900px]"/>
      ...
      <div className="text-white flex flex-col z-10 absolute bottom-[460px] 2xl:bottom-[550px] 3xl:bottom-[820px] items-center">
        <p className="text-center text-2xl xl:text-3xl 2xl:text-5xl font-medium banner-name">Randy Muhammad Sapoetra</p>
        <h1 className="banner-text text-5xl sm:text-[150px] 2xl:text-[190px] font-black tracking-wider sm:-ml-2.5 flex items-center">
          DREAMOCEL
        </h1>
      </div>
    </section>
